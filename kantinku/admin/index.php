...
<head>
	...
	<link rel="icon" href="../assets/img/kantin.png" type="image/x-icon" />
	...
	<div class="wrapper">
		...
		<div class="main-header" data-background-color="orange">
			...
			<div class="logo-header">
				...
				<a href="#" class="logo">
					<img src="../assets/img/kantin1.png" alt="navbar brand" class="navbar-brand" style="width: 50px; height:50px;">
				</a>
